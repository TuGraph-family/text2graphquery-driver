...
ADAPTER_PATH = os.path.join(ROOT_PATH, "eval_similarity_grammar/output/adapter")
MERGED_MODELS = os.path.join(ROOT_PATH, "eval_similarity_grammar/output/merged_models")

# DATA_PATH = "/root/autodl-tmp/data/spider/pre_processed_data"
# OUT_DIR= "/root/autodl-tmp/codellama"

DATA_PATH = os.path.join(ROOT_PATH, "eval_similarity_grammar/data")
PREDICTED_DATA_PATH = os.path.join(
    ROOT_PATH, "eval_similarity_grammar/data/tugraph-db-example/dev.json"
)
PREDICTED_OUT_FILENAME = "pred_gql.txt"
# OUT_DIR = os.path.join(DATA_PATH, "out_pred")
OUT_DIR = os.path.join(ROOT_PATH, "eval_similarity_grammar/output/")

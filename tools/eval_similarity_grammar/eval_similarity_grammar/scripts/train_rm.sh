...
deepspeed --num_gpus 4  eval_similarity_grammar/train/rm_train.py \
    --deepspeed eval_similarity_grammar/configs/ds_config.json \
    --stage rm \
    ...
    --lora_rank 64 \
    --lora_alpha 32 \
    --output_dir eval_similarity_grammar/output/adapter/qwen-7b-rm-test \
    --overwrite_cache \

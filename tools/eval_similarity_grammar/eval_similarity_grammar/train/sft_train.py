...
from eval_similarity_grammar.configs.config import IGNORE_INDEX
...
from eval_similarity_grammar.llm_base.model_trainer import (
    ComputeMetrics,
    Seq2SeqPeftTrainer,
...
if TYPE_CHECKING:
    from eval_similarity_grammar.configs import (
        DataArguments,
        FinetuningArguments,
        GeneratingArguments,
        ModelArguments,
